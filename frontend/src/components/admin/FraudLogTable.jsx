    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h3 className="font-bold text-slate-800 text-lg">Security Incidents & Fraud Attempts</h3>
                    <p className="text-xs text-slate-500">Monitor and review flagged polling activities</p>
                </div>
                ...
                <div className="flex flex-wrap gap-2 w-full md:w-auto">
                    ...
                    <div className="relative flex-grow md:flex-grow-0">
                        ...
                        <input
                            ...
                            className="pl-9 pr-4 py-2 text-sm border border-slate-300 rounded focus:ring-2 focus:ring-janmat-blue outline-none w-full md:w-64"
                        />
                        {searchQuery && (
                            <button
                    ...
                    {/* Filters */}
                    <select
                        className="px-3 py-2 text-sm border border-slate-300 rounded focus:ring-2 focus:ring-janmat-blue outline-none bg-white"
                        value={filters.type}
